...
(defcustom brec-original-math-functions ()
  "Functions to call on first display of original mathematics.
These functions are called on first display of each instance of mathematics
(see `brec-math-block-delimiter-char' and `brec-math-inline-delimiter-char')
that was present in a buffer when Brec Mode was activated for it.  You may want
to use this hook, for example, to overlay the mathematics with preview images
generated by a LaTeX/TeX processor.
